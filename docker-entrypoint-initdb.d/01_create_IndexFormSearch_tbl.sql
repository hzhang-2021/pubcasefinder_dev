...
CREATE TABLE `IndexFormSearch` (
  ...
  `source`    varchar(30) character set utf8 collate utf8_bin NOT NULL,
   PRIMARY KEY  (`id`),
   KEY `X_IndexFormSearch_uid` (`uid`),
   KEY `X_IndexFormSearch_value` (`value`),
   KEY `X_IndexFormSearch_uid_value` (`uid_value`),
   KEY `X_IndexFormSearch_source` (`source`)

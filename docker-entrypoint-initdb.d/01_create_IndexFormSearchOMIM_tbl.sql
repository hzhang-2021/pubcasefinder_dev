...
CREATE TABLE `IndexFormSearchOMIM` (
  ...
  `source`    varchar(30) character set utf8 collate utf8_bin NOT NULL,
   PRIMARY KEY  (`id`),
   KEY `X_IndexFormSearchOMIM_uid` (`uid`),
   KEY `X_IndexFormSearchOMIM_value` (`value`),
   KEY `X_IndexFormSearchOMIM_uid_value` (`uid_value`),
   KEY `X_IndexFormSearchOMIM_source` (`source`)

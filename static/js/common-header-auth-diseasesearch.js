...
modal_login.innerHTML = `
    <button type="button" class="modal-login-button" onclick="window.location.href='/google-login?service=diseasesearch'">
      <span><img src="/static/images/panelsearch/g-logo.png"><span>Log in</span></span>
    </button>
    <div class="modal-login-or">OR</div>
    <div>
      <button class="modal-login-button" onclick="location.href='/google-goto-signup?target=diseasesearch'">Sign up</button>
    </div>
